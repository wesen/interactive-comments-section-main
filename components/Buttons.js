export const DeleteButton = ({ onClick }) => {
  return (
    ...
    >
      ...
      <a
        className="text-body font-medium text-soft-red desktop:group-hover:text-pale-red"
        href="#"
        onClick={(e) => {
          e.preventDefault()
          onClick()
...
export const EditButton = ({ onClick }) => {
  return (
    ...
    >
      ...
      <a
        className="text-body font-medium text-moderate-blue desktop:group-hover:text-light-grayish-blue"
        href="#"
        onClick={(e) => {
          e.preventDefault()
          onClick()
